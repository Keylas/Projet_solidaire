...
class Adherent(models.Model):
	...
	chambre = models.CharField(max_length=4, verbose_name="Numéros de chambre", validators=[RegexValidator(regex=r'^([A-DH][0-3][01][0-9])?$', message="Erreur: cette chambre ne peut exister")], unique=True, null=True)
...
class Ordinateur(models.Model):
	nom = models.CharField(max_length=30, primary_key=True, verbose_name="nom indice du PC")
